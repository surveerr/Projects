...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Master Gaurav"<<endl;
        string phrase = "Good Morning Master Gaurav";
        ...
        cout<< "Good Afternoon Master Gaurav"<<endl;
        string phrase = "Good Afternoon Master Gaurav";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Master Gaurav"<<endl;
        string phrase = "Good Evening Master Gaurav";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER Gaurav|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER Gaurav";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="gaurav")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Master Gaurav...."<<endl<<endl;

                string phrase = "How can i help you Master Gaurav";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Master Gaurav....."<<endl;
                    string phrase = "Hello Master Gaurav";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Master Gaurav !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Master Gaurav !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                else if(command=="open notepad")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    CreateProcess(TEXT("C:\Program Files\WindowsApps\Microsoft.WindowsNotepad_10.2103.6.0_x64__8wekyb3d8bbwe\Notepad"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
                }
                ...
                else if(command=="play music")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    system("start https://www.youtube.com/watch?v=u_wB6byrl5k");
                }
                ...
                else if(command=="open video")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","C:\\Users\\LENOVO\\Desktop\\asd.mp4",NULL, NULL, SW_NORMAL);
                }

                else if(command=="bye" || command=="exit")
                {
                    cout<<"Good Bye Master Gaurav, see you soon!"<<endl;
                    string phrase = "Good Bye Master Gaurav, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
